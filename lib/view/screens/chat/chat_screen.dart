...
import 'package:live_app/view/screens/chat/widget/chat_list_view.dart';
import 'package:live_app/view/screens/chat/widget/chat_user_image.dart';
          ...
          appBar: (AppBar(
            ...
            title: Text(chatController
                ...
                : widget.user != null
                    ...
                    : '${chatController.chatModelStatic?.conversation?.receiver?.fName}'
                        ' ${chatController.chatModelStatic?.conversation?.receiver?.lName}'),
            backgroundColor: Theme.of(context).primaryColor,
            actions: <Widget>[
             ChatUserImage(chatController: chatController),
            ],
          )),
          body: isLoggedIn
              ? SafeArea(
                  child: Center(
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ChatListView(notificationBody: widget.notificationBody!,),
                          (chatController.chatModelStatic != null &&
                                  (chatController.chatModelStatic!.status! ||
                                      chatController
                                          .chatModelStatic!.messages!.isEmpty))
                              ? Container(
